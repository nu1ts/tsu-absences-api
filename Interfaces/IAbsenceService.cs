...
public interface IAbsenceService
{
    ...
    Task<AbsenceListResponse> GetAbsencesAsync(
        AbsenceFilterDto filterDto, 
        AbsenceSorting sorting, 
        int page, int size, 
        IQueryable<Absence>? query = null);
    Task<AbsenceListResponse> GetAbsencesForStudentAsync(
        Guid studentId, 
        AbsenceFilterDto filterDto, 
        AbsenceSorting sorting, 
        int page, 
        int size);
    Task<AbsenceListResponse> GetAbsencesForTeacherAsync(
        AbsenceFilterDto filterDto, 
        AbsenceSorting sorting, 
        int page, 
        int size, 
    ...
    Task ExtendAbsenceAsync(Guid userId, Guid absenceId, ExtendAbsenceDto dto, bool isDeanOffice);
}